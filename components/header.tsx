          ...
          <div className="flex items-center justify-between h-14 lg:h-16 xl:h-20">
                          ...
                          <DropdownMenuItem key={child.href} asChild className="rounded-none">
                            <Link
                              ...
                              className={cn(
                                ...
                                pathname === child.href ? "text-jgen-rose" : "text-gray-800"
                              )}
                            >
                              {child.label}
                            </Link>
            ...
            <div className="hidden lg:flex items-center gap-4 flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-jgen-vert flex items-center justify-center">
                  <a 
                    href="https://www.facebook.com/JGENSenegal/" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-8 h-8 rounded-full bg-white hover:bg-jgen-rose flex items-center justify-center transition-colors"
                    aria-label="Facebook"
                  >
                    <svg className="w-4 h-4 text-jgen-plum hover:text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Button
                size="sm"
                className="bg-jgen-rose text-white hover:bg-[#b01a45] font-bold px-4 xl:px-6 rounded-none text-xs whitespace-nowrap"
      ...
      {isMounted && isMenuOpen && createPortal(
        <>
          ...
          <div className="lg:hidden fixed left-0 top-0 bottom-0 w-[85%] sm:w-[400px] bg-white z-[9999] overflow-y-auto animate-in slide-in-from-left duration-300 shadow-2xl">
            ...
            <button
              onClick={() => setIsMenuOpen(false)}
              className="absolute top-4 left-4 p-2 text-jgen-plum hover:text-jgen-rose transition-colors"
                  ...
                  if (item.children) {
                    return (
                      <div key={item.href} className="border-b border-gray-200 py-4">
                        <p className="text-xl font-bold uppercase tracking-wide text-jgen-plum">
                          {item.label}
                        </p>
                        <div className="mt-3 space-y-2 pl-4 border-l-2 border-jgen-jaune">
                          {item.children.map((child) => (
                            <Link
                              key={child.href}
                              href={child.href}
                              className={cn(
                                ...
                                pathname === child.href
                                  ? "text-jgen-rose"
                                  : "text-jgen-plum hover:text-jgen-rose hover:translate-x-2",
                              )}
                              onClick={() => setIsMenuOpen(false)}
                            >
                              {child.label}
              ...
              <div className="pt-6 mt-6 border-t border-gray-200 space-y-6">
                ...
                <div className="flex items-center gap-4 justify-start">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-full bg-jgen-plum/10 hover:bg-jgen-rose flex items-center justify-center transition-colors group"
                    aria-label="Facebook"
                  >
                    <svg className="w-5 h-5 text-jgen-plum group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
