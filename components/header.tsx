      ...
      <header className={cn(
        ...
        <div className="w-full px-3 sm:px-4 lg:px-6 xl:px-8">
          <div className="flex items-center justify-between h-14 lg:h-16 xl:h-20">
            ...
            <button 
              className={cn(
                "xl:hidden p-2 flex-shrink-0 transition-colors z-50 relative",
          ...
          {isMenuOpen && (
            <div className="xl:hidden fixed inset-0 top-14 lg:top-16 bg-gradient-to-br from-[#3d1f47] to-[#2d1537] z-40 overflow-y-auto animate-in fade-in slide-in-from-top-4 duration-300">
              <nav className="flex flex-col h-full px-6 py-8 animate-in fade-in slide-in-from-top-8 duration-500 delay-100">
                {/* Menu Items */}
                <div className="flex-1 space-y-2">
                  {navItems.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      className={cn(
                        "block py-4 text-2xl font-bold uppercase tracking-wide transition-all border-b border-white/10",
                        pathname === item.href 
                          ? "text-[#c61d4d]" 
                          : "text-white hover:text-[#c61d4d] hover:translate-x-2",
                      )}
                ...
                <div className="pt-8 border-t border-white/20">
                  {/* Newsletter Button */}
                  <Button
                    className="w-full bg-[#00d4aa] text-[#3d1f47] hover:bg-[#00c199] font-black text-lg py-6 rounded-none uppercase tracking-wide"
                    onClick={() => {
