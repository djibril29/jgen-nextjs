  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-jgen-plum to-[#2d1537] relative overflow-hidden">
        {/* Decorative squares */}
        <div className="absolute top-10 left-10 w-20 h-20 bg-jgen-violet opacity-40 z-0" />
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-jgen-vert opacity-30 z-0 rotate-45" />
        <div className="absolute top-1/2 right-20 w-24 h-24 bg-jgen-jaune opacity-25 z-0 -rotate-12" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="bg-jgen-rose hover:bg-[#b01a45] text-white font-bold text-base px-8 py-6 h-auto"
              >
                <Link href="/contact">
                  Participer
                </Link>
