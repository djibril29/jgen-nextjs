...
export function AssisesFeedback() {
  return (
    ...
    >
      <div
        aria-hidden
        className="absolute top-10 -left-24 w-80 h-80 rounded-full bg-jgen-vert/15 blur-3xl pointer-events-none"
      />
      <div
        aria-hidden
        className="absolute bottom-10 -right-24 w-80 h-80 rounded-full bg-jgen-jaune/15 blur-3xl pointer-events-none"
      />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        <div className="max-w-4xl mx-auto mb-12 lg:mb-16">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-jgen-rose to-[#8a1438] text-white p-8 lg:p-12 shadow-[0_25px_60px_-15px_rgba(198,29,77,0.5)]">
            ...
            <div
              aria-hidden
              className="absolute -bottom-16 -left-16 w-64 h-64 rounded-full bg-jgen-plum/40 blur-3xl pointer-events-none"
            />

            <div className="relative grid md:grid-cols-[1fr_auto] items-center gap-8">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <Smartphone className="h-4 w-4 text-jgen-jaune" />
                  <span className="text-jgen-jaune text-xs font-bold uppercase tracking-[0.2em]">
                ...
                <p className="text-white/65 text-sm">
                  ...
                  <span className="inline-block bg-white/10 border border-white/20 text-jgen-jaune font-mono font-bold tracking-widest px-2 py-0.5 rounded">
                    {VOTE_CODE}
                  </span>{" "}
                  sur{" "}
                  <a
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="relative flex h-2.5 w-2.5">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-jgen-rose opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-jgen-rose"></span>
            </span>
            <span className="inline-flex items-center gap-2 text-jgen-rose text-xs font-bold uppercase tracking-[0.25em]">
          ...
          <div className="relative rounded-3xl bg-white shadow-[0_25px_60px_-15px_rgba(61,31,71,0.25)] border border-jgen-plum/10 overflow-hidden">
            <div className="flex items-center gap-2 bg-jgen-plum text-white px-5 py-3 border-b border-white/10">
              <span className="flex gap-1.5" aria-hidden>
                ...
                <span className="h-2.5 w-2.5 rounded-full bg-jgen-jaune" />
                <span className="h-2.5 w-2.5 rounded-full bg-jgen-vert" />
              </span>
              <div className="flex items-center gap-2 ml-2">
                <MessageCircleHeart className="h-4 w-4 text-jgen-jaune" />
