...
export function AssisesHero() {
  return (
    <section className="relative isolate overflow-hidden pt-14 lg:pt-20 bg-jgen-plum">
      <Image
        src="/Hero.png"
      ...
      <div
        aria-hidden
        className="absolute inset-0 -z-10 bg-gradient-to-r from-jgen-plum/20 via-transparent to-jgen-plum/60 lg:from-transparent lg:via-transparent lg:to-jgen-plum/70"
      />
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 min-h-[78vh] lg:min-h-[88vh] items-center">
          ...
          <div className="py-16 lg:py-24 max-w-2xl lg:pl-6">
            <span className="inline-flex items-center gap-2 bg-jgen-jaune text-jgen-plum text-[11px] sm:text-xs font-bold uppercase tracking-[0.2em] px-4 py-2 rounded-full mb-6 shadow-md">
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="h-[3px] w-12 bg-jgen-vert rounded-full" />
              <span className="text-jgen-vert text-xs sm:text-sm font-bold uppercase tracking-[0.18em]">
                Comité de pilotage
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 bg-jgen-rose hover:bg-[#a8173f] text-white font-bold px-7 py-3.5 rounded-full transition-all hover:shadow-xl hover:-translate-y-0.5"
              >
                Participer en ligne
      ...
      <div
        aria-hidden
        className="absolute bottom-0 left-0 right-0 h-1.5 bg-gradient-to-r from-jgen-rose via-jgen-jaune to-jgen-vert"
      />
    </section>
  )
}
