          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div ref={imageReveal.ref} className={`scroll-reveal-right ${imageReveal.isVisible ? "is-visible" : ""}`}>
              <div className="relative">
                ...
                <div className="absolute -top-6 -left-6 w-32 h-32 bg-jgen-rose opacity-80 z-0" />
                <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-jgen-jaune opacity-90 z-0 rotate-12" />
                <div className="absolute top-1/2 -right-4 w-24 h-24 bg-jgen-violet opacity-70 z-0" />
