...
const values = [
  ...
  },
  {
    ...
    bgColor: "bg-jgen-jaune",
    textColor: "text-jgen-plum",
    iconBg: "bg-jgen-plum/20",
    iconColor: "text-jgen-plum",
  },
  {
    icon: Shield,
    title: "Protection",
...
export function Values() {
  return (
    <section id="values" className="py-20 lg:py-32 bg-white relative overflow-hidden">
      {/* Decorative squares */}
      <div className="absolute top-20 right-10 w-24 h-24 bg-jgen-jaune opacity-30 z-0 rotate-12" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-jgen-rose mx-auto mb-8" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {values.map((value, index) => (
            ...
            >
              ...
              <p className={`leading-relaxed text-sm ${value.textColor} ${value.bgColor === 'bg-jgen-jaune' ? 'opacity-90' : 'opacity-95'} relative z-10`}>{value.description}</p>
            </div>
          ))}
        </div>
      </div>
